...
class AppointmentController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        //Si formulaire bien remplie : enregistrement + affichage de la liste des RDV
        if ($form->isSubmitted() && $form->isValid()) {
            $entityManager = $this->getDoctrine()->getManager();
            $entityManager->persist($appointment);
            $entityManager->flush();

            $this->addFlash('notice', "Demande de RDV enregistrée"); //message flash

            return $this->redirectToRoute('homepage'); //redirection vers homepage
        }
